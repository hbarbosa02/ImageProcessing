...
namespace LinAlg {
    ...
    template <typename Type>
    Type sum(const LinAlg::Matrix<Type> &mat);
    ...
    template <typename Type>
    LinAlg::Matrix<Type> sumPointToPoint(const LinAlg::Matrix<Type> &left, const LinAlg::Matrix<Type> &right);

    template <typename Type>
    LinAlg::Matrix<Type> subPointToPoint(const LinAlg::Matrix<Type> &left, const LinAlg::Matrix<Type> &right);
