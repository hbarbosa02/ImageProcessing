...
template <typename Type>
Type LinAlg::sum(const LinAlg::Matrix<Type> &mat)
{
    Type sum = 0;
...
template <typename Type>
LinAlg::Matrix<Type> LinAlg::sumPointToPoint(const LinAlg::Matrix<Type> &left, const LinAlg::Matrix<Type> &right)
{
...
template <typename Type>
LinAlg::Matrix<Type> LinAlg::subPointToPoint(const LinAlg::Matrix<Type> &left, const LinAlg::Matrix<Type> &right)
{
    LinAlg::Matrix<Type> ret = LinAlg::Zeros<Type>(left.getNumberOfRows(),left.getNumberOfColumns());
...
template <typename Type>
LinAlg::Matrix<Type> LinAlg::multPointToPoint(const LinAlg::Matrix<Type> &left, const LinAlg::Matrix<Type> &right)
{
    LinAlg::Matrix<Type> ret = LinAlg::Zeros<Type>(left.getNumberOfRows(),left.getNumberOfColumns());
